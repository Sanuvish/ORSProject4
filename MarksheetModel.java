...
public class MarksheetModel {
	...
	public MarksheetBean findByRollNo(String rollNo) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT *, (PHYSICS + CHEMISTRY + MATHS) AS total, (( PHYSICS + CHEMISTRY + MATHS)/3) AS  paracenatge FROM  st_marksheet WHERE roll_no=? ORDER BY total DESC");
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer("SELECT ID,ROLL_NO, NAME, PHYSICS, CHEMISTRY, MATHS , (PHYSICS + CHEMISTRY + MATHS) AS total, (( PHYSICS + CHEMISTRY + MATHS)/3) AS  paracenatge FROM  st_marksheet WHERE ((PHYSICS >33) AND (CHEMISTRY >33)AND(MATHS>33 )) ORDER BY total DESC");
		// if page size is greater than zero then apply pagination
		if (pageSize > 0) {
			// Calculate start record index
			pageNo = (pageNo - 1) * pageSize;
	...
	public List getMeritList(int pageNo, int pageSize) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer(
				...
				+ "(( PHYSICS + CHEMISTRY + MATHS)/3) AS  paracenatge FROM  st_marksheet WHERE ((PHYSICS >33) AND"
