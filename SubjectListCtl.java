...
/**
 * Suject List functionality Controller. Performs operation for list, search
...
public class SubjectListCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setCourseName(DataUtility.getString(request.getParameter("COURESName")));
		return bean;
	}
	/**
